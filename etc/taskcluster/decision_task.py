...
def windows_x86():
    return (
        ...
        .with_script(
            ...
            "rustup target list",
            "rustup show",
            #"python mach build --dev --target i686-pc-windows-msvc --diagnostic",
            "python mach build --dev --target i686-pc-windows-msvc || type target\\i686-pc-windows-msvc\\debug\\build\\expat-sys-d1fb8aaa671e3805\\out\\build\\CMakeFiles\\CMakeOutput.log target\\i686-pc-windows-msvc\\debug\\build\\expat-sys-d1fb8aaa671e3805\\out\\build\\CMakeFiles\\CMakeError.log",
        )
